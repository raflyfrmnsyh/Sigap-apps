...
<head>
    ...
    <!-- CSS -->
    @yield('css')
    <link rel="stylesheet" href="Masyarakat/Assets/css/landing.css">
</head>
<body>
            ...
            <div class="container-md">
                <div class="navbar">
                    ...
                    <ul class="nav-menu">
                        ...
                        @if (!Auth::check())
                            <li class="nav-item btn btn-login">
                                <a href="{{ route('login.masyarakat') }}">Masuk</a>
                            </li>
                            <li class="nav-item btn" style="margin-left:10px;">
                                <a href="{{ route('register.masyarakat') }}">Daftar</a>
                            </li>
                        @endif
                    ...
                    <div class="cta-btn">
                        @if (Auth::check())
                            @if (auth()->user()->role_id == 1 || auth()->user()->role_id == 2)
                                <a href="{{ route('admin.dashboard') }}" class="logBtn">
                                    <i class="bx bx-line-chart"></i>
                                </a>
                            @endif
                            @if (auth()->user()->role_id == 3)
                                <a href="{{ route('beranda.masyarakat') }}" class="logBtn">
                        ...
                        @if (!Auth::check())
                            <a href="{{ route('login.masyarakat') }}" class="logBtn">
